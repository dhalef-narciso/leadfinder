...
export class SerpApiMapsProvider implements IMapsSearchProvider {
  readonly providerName = 'SerpApiMapsProvider';
  ...
  async search(query: string, location: string, options?: MapsSearchOptions): Promise<RawMapsBusiness[]> {
    ...
    while (results.length < targetLimit && hasMore) {
      ...
      for (const item of localResults) {
        ...
        const business: RawMapsBusiness = {
