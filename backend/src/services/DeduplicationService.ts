...
export class DeduplicationService {
   ...
   */
  static generateIdentityKey(inputs: DeduplicationInputs): string {
   ...
   */
  static mergeMapsBusinesses(existing: RawMapsBusiness, incoming: RawMapsBusiness): RawMapsBusiness {
    return {
   ...
   */
  static deduplicateMapsBusinesses(items: RawMapsBusiness[], location: string): RawMapsBusiness[] {
    const map = new Map<string, RawMapsBusiness>();
