export type UrlValidationStatus = 'VALID' | 'INVALID' | 'UNREACHABLE' | 'UNVERIFIED' | 'NOT_CHECKED';
...
export class UrlValidationService {
   ...
   */
  static isValidUrlFormat(urlStr: string): boolean {
  ...
  static async validateUrl(
    ...
    source: string = 'search_result',
    options?: { isDemo?: boolean; liveCheck?: boolean; timeoutMs?: number }
  ): Promise<UrlValidationRecord> {
